...
def handle_update(update):
    ...
    if idx + 1 < len(STATES):
        ...
        prompts = {
            ...
            "NOTE": "Введите <b>Примечание</b>:",
            "COMMENTS": "<b>Комментарии:</b> Ссылка или Zoro Store:",
            "BG": "Отправьте <b>Фон</b>:",
            ...
            "EXTRA_NAMES": "Названия доп. файлов:",
        ...
        if d.get("GAME_FILE"): bot_api("sendDocument", {"chat_id": GROUP_ID, "document": d["GAME_FILE"]})
        send_msg(chat_id, "✅ Отправлено в модерацию.")
        user_states[chat_id] = None

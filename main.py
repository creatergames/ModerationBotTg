...
... ​📋 Правила размещения ZGS
​1. Закон и этика
​Приложение и контент не должны нарушать Конституцию РФ.
​Запрещены: порнография, вирусы, вредоносное ПО, шок-контент и дискриминация.
​Запрет Meta:* Ссылки на платформы Meta (Instagram, Facebook) строго запрещены.
​2. Визуальный контент (Плакат)
​Изображение строго 164px h256px.
​Запрещен чужой авторский контент и изображения, нарушающие законы РФ.
​3. Цена и ссылки
​Цена: от 3 ₽ до 50 000 ₽.
​Ссылки: только на рабочие и легальные ресурсы. Названия ссылок не должны вводить в заблуждение.
​Магазин не несет ответственности за содержание внешних страниц.
​4. Технические данные
​Файлы: любой формат до 100 ГБ.
​Рекомендуется прикладывать отчет о тестировании и список исправлений.
​Нарушение любого пункта приведет к отказу в публикации.
